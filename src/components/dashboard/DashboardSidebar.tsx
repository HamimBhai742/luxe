      ...
      <div className="space-y-5 mt-6">
        ...
        <div className="space-y-0.5 border-t border-zinc-100 dark:border-zinc-900 pt-3">
          <Link
            ...
            className="w-full flex items-center gap-3.5 rounded-xl px-3.5 py-2.5 text-xs font-bold text-zinc-650 hover:bg-zinc-50 hover:text-zinc-900 dark:text-zinc-400 dark:hover:bg-zinc-900/50 dark:hover:text-zinc-100 cursor-pointer transition-colors"
          >
            <svg className="h-4.5 w-4.5 text-zinc-450" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
